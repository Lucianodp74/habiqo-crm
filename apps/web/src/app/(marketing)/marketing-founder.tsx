// app/(marketing)/marketing-founder.tsx — versione aggiornata

export function MarketingFounder() {
  return (
    <section id="founder-access" className="py-20 px-6 lg:px-16">
            ...
            <div className="p-10 lg:p-16">
              <div className="inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-full border border-[rgba(166,124,82,0.4)] bg-[rgba(166,124,82,0.08)]">
                ...
                <span className="font-mono text-[11px] uppercase tracking-[0.2em] text-[#a67c52]">
                  Founder Program · Accesso selettivo
                </span>
              </div>

              <h2
                className="text-[clamp(1.8rem,3.5vw,2.6rem)] leading-[1.08] tracking-[-0.02em] text-white mb-6"
                style={{ fontWeight: 700 }}
              >
                Stiamo selezionando le prossime agenzie{' '}
                <em style={{ fontStyle: 'italic', color: '#a67c52' }}>Founder.</em>
              </h2>

              <p
                className="text-[15px] leading-[1.65] text-[rgba(255,255,255,0.55)] mb-8 max-w-[420px]"
                style={{ fontFamily: 'system-ui, sans-serif', fontWeight: 400 }}
              >
                Non è un abbonamento. È un accesso riservato a poche agenzie
                selezionate che vogliono trasformare il loro modo di lavorare.
                Con supporto diretto, onboarding personalizzato e accesso
                anticipato a ogni nuova funzionalità.
              </p>

              <ul className="space-y-3 mb-10">
                {[
                  'Onboarding 1:1 con il fondatore',
                  'Accesso prioritario a ogni nuova funzionalità',
                  'Supporto diretto — nessun ticket, nessuna attesa',
                  'Influenza diretta sulla roadmap del prodotto',
                  'Condizioni riservate permanenti',
                ].map(benefit => (
              ...
              <p
                ...
                style={{ fontFamily: 'system-ui, sans-serif' }}
              >
                Posti limitati · Nessuna carta di credito richiesta
              </p>
            </div>
            ...
            <div className="p-10 lg:p-16 flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-[rgba(255,255,255,0.06)]">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { icon: '👥', title: 'Team senza limiti',          desc: 'Invita tutti gli agenti della tua agenzia.' },
                  { icon: '🌐', title: 'Sito Habita incluso',        desc: 'Il tuo sito pubblico con immobili e AI renovation.' },
                  { icon: '📞', title: 'Supporto diretto',           desc: 'Accesso diretto al fondatore per qualsiasi esigenza.' },
                ].map(item => (
