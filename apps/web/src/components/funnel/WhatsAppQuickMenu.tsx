...
// ─── Template actions ─────────────────────────────────────────────
// Indipendenti dallo stage — l'agente sceglie quello più appropriato.
...
export function WhatsAppQuickMenu({
  ...
  // Evidenzia il template consigliato per lo stage corrente
    ...
    <div className="relative inline-block" ref={menuRef}>
      ...
      {open && (
        <div className="absolute left-0 top-full mt-1.5 z-[200] w-72 rounded-2xl border border-[var(--border-subtle)] bg-white shadow-[0_16px_48px_-12px_rgba(24,20,16,0.35)] overflow-hidden" style={{ isolation: 'isolate' }}>
              ...
              return (
                <li key={action.id}>
                  <a
                    ...
                    className={`flex items-start gap-3 px-3 py-2.5 hover:bg-[var(--bg-sunken)] transition-colors group ${
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[11px] text-[var(--fg-muted)] mt-0.5 line-clamp-2 leading-relaxed">
                        {message.slice(0, 80)}…
                      </p>
                    </div>
                    <svg
                      ...
                      stroke="currentColor"
                      strokeWidth="2"
                      className="shrink-0 mt-1 text-[var(--fg-muted)] group-hover:text-green-600 transition-colors"
                      aria-hidden
                    >
          ...
          <div className="px-3 py-2 border-t border-[var(--border-subtle)] bg-[var(--bg-sunken)]/60">
