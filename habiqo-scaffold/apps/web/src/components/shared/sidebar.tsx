        ...
        <ul className="space-y-0.5">
          ...
          {agencySlug ? (
            <li>
              ...
              >
                Sito pubblico
                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="opacity-50">
                  <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
                  <polyline points="15 3 21 3 21 9" />
                  <line x1="10" y1="14" x2="21" y2="3" />
                </svg>
      ...
      <div className="px-3 py-4 border-t border-[var(--border-subtle)] space-y-3">
        ...
        <div className="flex items-center gap-2.5 px-2 py-1.5 rounded-md">
          <div
            ...
            style={{ background: "var(--color-onyx-900)", color: "var(--color-brass-soft)" }}
          >
            {avatarUrl ? (
