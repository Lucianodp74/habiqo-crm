...
export default function AiAssistantPage() {
  return (
    <div className="px-5 py-6 lg:px-10 lg:py-8">
      <p className="font-mono text-[10px] tracking-[0.22em] uppercase text-[var(--fg-muted)]">AI Assistant</p>
      ...
      <p className="text-[14px] text-[var(--fg-secondary)] mt-2 max-w-2xl">
        Chat e strumenti in arrivo: follow-up automatici, riepiloghi lead, proposte, analisi delle obiezioni e script
        chiamate.
      </p>
