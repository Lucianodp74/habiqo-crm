  ...
  public: {
    Tables: {
      ...
      lead_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_documents_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      lead_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "lead_events_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      lead_insights: {
        Row: {
          ...
          next_action_headline: string | null
      ...
      leads: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "leads_source_property_id_fkey"
      ...
      property_matches: {
        ...
        Relationships: [
          {
            foreignKeyName: "property_matches_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      renovation_previews: {
        ...
        Relationships: [
          {
            foreignKeyName: "renovation_previews_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "renovation_previews_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
            referencedRelation: "properties"
            referencedColumns: ["id"]
      ...
      valuation_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "valuation_requests_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "valuation_requests_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
      ...
      valuations: {
        ...
        Relationships: [
          {
            foreignKeyName: "valuations_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "valuations_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      current_agency_ids: { Args: never; Returns: string[] }
      current_role_in: {
